...
var computedDecorator = createPropDecorator(false, function (instance, propertyName, descriptor, decoratorTarget, decoratorArgs) {
  ...
  defineComputedProperty(instance, propertyName, _assign({ get: get, set: set }, options));
});
...
function checkIfStateModificationsAreAllowed(atom) {
  ...
  if (globalState.computationDepth > 0 && hasObservers) fail("Computed values are not allowed to cause side effects by changing observables that are already being observed. Tried to modify: " + atom.name);
...
var ObservableArrayAdministration = /** @class */function () {
  ...
  ObservableArrayAdministration.prototype.notifyArrayChildUpdate = function (index, newValue, oldValue) {
    ...
    if (notifySpy) spyReportStart(_assign(_assign({}, change), { name: this.atom.name }));
...
var ObservableMap = /** @class */function () {
  ...
  ObservableMap.prototype.delete = function (key) {
    ...
    if (this._has(key)) {
      ...
      if (notifySpy) spyReportStart(_assign(_assign({}, change), { name: this.name, key: key }));
  ...
  ObservableMap.prototype.toPOJO = function () {
    ...
    var res = {};
    this._keys.forEach(function (key) {
      return res[(typeof key === "undefined" ? "undefined" : _typeof(key)) === "symbol" ? key : stringifyKey(key)] = _this.get(key);
    });
    return res;
  };
  /**
...
var ObservableSet = /** @class */function () {
  ...
  ObservableSet.prototype.add = function (value) {
    ...
    if (!this.has(value)) {
      ...
      if (notifySpy && true) spyReportStart(change);
      if (notify) notifyListeners(this, change);
  ...
  ObservableSet.prototype.delete = function (value) {
    ...
    if (this.has(value)) {
      ...
      if (notifySpy && true) spyReportStart(_assign(_assign({}, change), { name: this.name }));
      transaction(function () {
        _this._atom.reportChanged();
...
function notifyPropertyAddition(adm, object, key, newValue) {
  ...
  if (notifySpy) spyReportStart(_assign(_assign({}, change), { name: adm.name, key: key }));
